...
const AboutPage = () => {
  return (
    <Container className="max-w-6xl lg:px-8 py-12">
      <h1 className="text-3xl font-bold mb-6">About Fifty9</h1>
      <p className="mb-4">
        Fifty9 is a cutting-edge technology company dedicated to providing
      ...
      <p>
        At Fifty9, we believe in the power of technology to transform businesses
